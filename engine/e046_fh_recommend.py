"""E046-A product surface: Free Hit recommendation (frozen policy).

Usage:
    python -m engine.e046_fh_recommend
    python -m engine.e046_fh_recommend --season 2024-25
    python -m engine.e046_fh_recommend --squad myteam.json
    python -m engine.e046_fh_recommend --json
"""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="E046-A frozen Free Hit recommendation (not a chip optimizer).",
    )
    parser.add_argument(
        "--season",
        default=None,
